                    ...
                    {props => {
                        ...
                        return (
                            <Form>
                                ...
                                <div className="wrapper fadeInDown">
                                    <div id="formContent">
                                        <input type="text" className="fadeIn second" name="code" onChange={handleChange} placeholder="code" />
                                        <ErrorMessage name="code">{msg => <div className="errorText">{msg}</div>}</ErrorMessage>
                                        <input type="password" className="fadeIn second" name="newPassword" onChange={handleChange} placeholder="new password" />
